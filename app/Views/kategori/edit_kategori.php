            ...
            <form action="/kategori/update/<?= $kategori['id_kategori']; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= ($validation->hasError('nama_kategori')) ? 'is-invalid' : ''; ?>" id="Nama Kategori" placeholder="Nama Kategori" name="nama_kategori" value="<?= $kategori['nama_kategori']; ?>">
